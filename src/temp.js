...
class Episode extends Component {
  ...
  render() {
    ...
    return (
    <div key={`${id}-episode-id`} className="episode row" onClick={this.showMoreorLess}>
        <img className={(this.state.displayAll ? 'expanded-img' : '')} src={require('./MBMBaM.jpg')} alt="My Brother, My Brother and Me Logo"></img>
        ...
        <div id={`${id}-completed`} className="completed col-3">
        ...
        <Modal show={this.state.show} onHide={this.handleClose}>
            <Modal.Header closeButton>
                <Modal.Title>{EpisodeTitle}</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <img className={(this.state.displayAll ? 'expanded-img' : '')} src={require('./MBMBaM.jpg')} alt="My Brother, My Brother and Me Logo"></img>
                <p>{EpisodeDescription}</p>
                <div id={`${id}-completed`} className="completed col-3"></div>
            </Modal.Body>
            <Modal.Footer>
